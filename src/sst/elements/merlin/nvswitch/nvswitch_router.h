...
#ifndef COMPONENTS_NVSWITCH_ROUTER_NVSWITCH_ROUTER_H
#define COMPONENTS_NVSWITCH_ROUTER_NVSWITCH_ROUTER_H
...
class nvswitch_router : public Router {
...
public:
    nvswitch_router(ComponentId_t cid, Params& params);
    ~nvswitch_router();
...
#endif // COMPONENTS_NVSWITCH_ROUTER_NVSWITCH_ROUTER_H
